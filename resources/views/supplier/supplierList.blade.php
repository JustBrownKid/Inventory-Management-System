...
<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Supplier List</h1>
        ...
        filteredData.forEach(customer => {
            ...
            row.innerHTML = `
                ...
                <td class="px-6 py-1 space-x-2">
                    ...
                    <form action="/customers/${customer.id}/delete" method="POST" onsubmit="return confirm('Are you sure you want to delete this customer?');" class="inline-block">
