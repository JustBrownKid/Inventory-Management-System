            ...
            filteredData.forEach(customer => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-2 border border-gray-300">
                        <a href="/supplier/${customer.id}/edit" 
                           class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-3 rounded mr-2 text-sm">
                           Edit
                        </a>
                        <form action="/supplier/${customer.id}/delete" method="POST" onsubmit="return confirm('Are you sure you want to delete this customer?');" class="inline-block">
